...
export default function Home() {
  return (
    <>
      <Head>
        <title>AristoByte UI</title>
        <meta name="description" content="Generated by create next app" />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <link rel="icon" href="/favicon.ico" />
      </Head>
      <div
        className={`flex flex-col place-content-center h-[100svh] place-items-center gap-8 px-5 sm:px-10 md:px-20 py-5 sm:py-10 md:py-20 font-sans ${geistSans.variable} ${geistMono.variable}`}
      >
        <Gradient />
